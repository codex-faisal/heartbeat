(() => {
    ...
    const WORDS = [
        'Stay ', 'Happy Forever', '❤', 'Happy Birthday', '🧧', 'Karima', 'গীতাঞ্জলি', 'Keep Smiling Always', 'you'
    ];
    ...
    function startCardLoader() {
        ...
        const steps = [
            ...
            { threshold: 80, text: 'Generating particles...' },
    ...
    const letterText = "Dear Karima,\nI coded this heartbeat for you...\n\nEvery line of code, every pixel, and every beat is a reminder of how much you mean to me.\n\nNo matter where life takes us, May your life run smoothly without any Stress, and may this new year bring you endless happiness.\n\n Hope you have an amazing day today! 💗";
